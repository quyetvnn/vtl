	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __d('company','add_company'); ?></h3>
			</div>
			...
			<div class="box-body table-responsive">
				<?php echo $this->Form->create('Company', array('role' => 'form')); ?>
					<fieldset>
						...
						<div class="form-group">
							<?php echo $this->Form->input('remark', array('class' => 'form-control ckeditor','label'=>__('remark'))); ?>
						</div>

						<div class="form-group">
							<?php echo $this->Form->input('contact_person', array('class' => 'form-control', 'label' => __d('company','contact_person'), 'placeholder' => __d('company','name'))); ?>
						</div>

						<div class="form-group">
							<?php echo $this->Form->input('contact_email', array('class' => 'form-control', 'label' => false, 'placeholder' => __('email'))); ?>
						</div>

						<div class="form-group">
							<?php echo $this->Form->input('contact_phone', array('class' => 'form-control', 'label' => false, 'placeholder' => __d('company','contact_phone'))); ?>
						</div>

						<div class="form-group">
							<?php echo $this->Form->input('contact_job_title', array('class' => 'form-control', 'label' => false, 'placeholder' => __d('company','contact_job_title'))); ?>
						</div>
