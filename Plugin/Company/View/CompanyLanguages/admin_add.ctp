	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __d('company','add_company_language'); ?></h3>
			</div>
			...
			<div class="box-body table-responsive">
				<?php echo $this->Form->create('CompanyLanguage', array('role' => 'form')); ?>
					<fieldset>
						...
						<div class="form-group">
							<?php echo $this->Form->input('name', array('class' => 'form-control','label' => '<font color="red">*</font>'.__d('company','name'))); ?>
						</div>
