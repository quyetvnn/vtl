<?php
App::uses('CompanyLanguagesController', 'Company.Controller');

/**
 * CompanyLanguagesController Test Case
 */
class CompanyLanguagesControllerTest extends ControllerTestCase {
