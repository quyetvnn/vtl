<?php
App::uses('ShopsCurrenciesController', 'Company.Controller');

/**
 * ShopsCurrenciesController Test Case
 */
class ShopsCurrenciesControllerTest extends ControllerTestCase {
