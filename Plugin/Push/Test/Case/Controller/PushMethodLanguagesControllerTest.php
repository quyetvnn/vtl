<?php
App::uses('PushMethodLanguagesController', 'Push.Controller');

/**
 * PushMethodLanguagesController Test Case
 */
class PushMethodLanguagesControllerTest extends ControllerTestCase {
