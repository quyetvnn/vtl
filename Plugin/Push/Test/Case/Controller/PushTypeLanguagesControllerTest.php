<?php
App::uses('PushTypeLanguagesController', 'Push.Controller');

/**
 * PushTypeLanguagesController Test Case
 */
class PushTypeLanguagesControllerTest extends ControllerTestCase {
