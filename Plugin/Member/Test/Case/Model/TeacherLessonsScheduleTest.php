<?php
App::uses('TeacherLessonsSchedule', 'Member.Model');

/**
 * TeacherLessonsSchedule Test Case
 */
class TeacherLessonsScheduleTest extends CakeTestCase {
 ...
 */
	public $fixtures = array(
		'plugin.member.teacher_lessons_schedule',
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TeacherLessonsSchedule = ClassRegistry::init('Member.TeacherLessonsSchedule');
	}
 ...
 */
	public function tearDown() {
		unset($this->TeacherLessonsSchedule);
