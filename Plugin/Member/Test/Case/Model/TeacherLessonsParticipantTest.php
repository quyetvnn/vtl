<?php
App::uses('TeacherLessonsParticipant', 'Member.Model');

/**
 * TeacherLessonsParticipant Test Case
 */
class TeacherLessonsParticipantTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TeacherLessonsParticipant = ClassRegistry::init('Member.TeacherLessonsParticipant');
	}
 ...
 */
	public function tearDown() {
		unset($this->TeacherLessonsParticipant);
