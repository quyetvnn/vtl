<?php
App::uses('MembersCreditsController', 'Member.Controller');

/**
 * MembersCreditsController Test Case
 */
class MembersCreditsControllerTest extends ControllerTestCase {
 ...
 */
	public $fixtures = array(
		...
		'plugin.member.credit_type_language'
	);
