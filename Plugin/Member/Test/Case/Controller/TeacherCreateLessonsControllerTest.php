<?php
App::uses('TeacherCreateLessonsController', 'Member.Controller');

/**
 * TeacherCreateLessonsController Test Case
 */
class TeacherCreateLessonsControllerTest extends ControllerTestCase {
