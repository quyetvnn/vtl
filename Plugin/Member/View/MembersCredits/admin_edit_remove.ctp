...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Admin Edit Members Credit'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('MembersCredit', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('credit_type_id', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('pay_dollar_ref', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('credit', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
