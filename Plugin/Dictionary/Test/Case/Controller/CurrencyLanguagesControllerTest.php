<?php
App::uses('CurrencyLanguagesController', 'Dictionary.Controller');

/**
 * CurrencyLanguagesController Test Case
 */
class CurrencyLanguagesControllerTest extends ControllerTestCase {
