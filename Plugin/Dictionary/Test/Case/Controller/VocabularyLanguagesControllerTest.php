<?php
App::uses('VocabularyLanguagesController', 'Dictionary.Controller');

/**
 * VocabularyLanguagesController Test Case
 */
class VocabularyLanguagesControllerTest extends ControllerTestCase {
