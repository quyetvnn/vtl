<?php
App::uses('ImageTypeLanguagesController', 'Dictionary.Controller');

/**
 * ImageTypeLanguagesController Test Case
 */
class ImageTypeLanguagesControllerTest extends ControllerTestCase {
