...
<div class="row">
    <div class="col-xs-12 col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			<div class="box-header">
			<h3 class="box-title"><?php echo __d('school', 'add_school_subject'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('SchoolSubject', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<?php echo $this->element('language_input_temp', array(
						...
						'languages_edit_data' => isset($this->request->data[$languages_model]) ? $this->request->data[$languages_model] : array(),
					)); ?>
