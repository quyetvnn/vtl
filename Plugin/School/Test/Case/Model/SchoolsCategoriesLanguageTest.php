<?php
App::uses('SchoolsCategoriesLanguage', 'School.Model');

/**
 * SchoolsCategoriesLanguage Test Case
 */
class SchoolsCategoriesLanguageTest extends CakeTestCase {
 ...
 */
	public $fixtures = array(
		'plugin.school.schools_categories_language',
		'plugin.school.category',
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SchoolsCategoriesLanguage = ClassRegistry::init('School.SchoolsCategoriesLanguage');
	}
 ...
 */
	public function tearDown() {
		unset($this->SchoolsCategoriesLanguage);
