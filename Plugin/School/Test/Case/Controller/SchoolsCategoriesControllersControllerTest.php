<?php
App::uses('SchoolsCategoriesControllersController', 'School.Controller');

/**
 * SchoolsCategoriesControllersController Test Case
 */
class SchoolsCategoriesControllersControllerTest extends ControllerTestCase {
 ...
 */
	public $fixtures = array(
		'plugin.school.schools_categories_controller',
