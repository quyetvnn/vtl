...
class PhpExcelComponent extends Component {
    ...
    public function output($filename = 'export.xlsx', $writer = 'Excel2007') {
        ...
        PHPExcel_Shared_File::setUseUploadTempDirectory(true);  // vilh: add this for fix: PhpSpreadsheet: Permissions | ZipArchive::close(): Failure to create temporary file
        // writer
        $objWriter = $this->getWriter($writer);
