	...
	<section class="sidebar">
        <ul class="sidebar-menu">
            <?php if(isset($permissions) && $permissions) {  ?>
                    ...
                    <li class="treeview 
                        ...
                        <?php
                            ...
                            $display = array(
                                ...
                                array(
                                    'plugin' =>  'member',
                                    'controller' =>   'members',
                                    'action' =>   'admin_import_student'
                                ),

                                array(
                                    'plugin' =>  'member',
                                    'controller' =>   'members',
                                    'action' =>   'admin_import_teacher'
                                ),
                            );

                            foreach ($display  as $val) {
                                if ($this->params['plugin']     == $val['plugin'] && 
                                    $this->params['controller'] == $val['controller'] &&  
                                    $this->params['action']     == $val['action']) {
                                        echo " active";
                                        break;
                                }
                            } 
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($is_admin) { ?>
                                ...
                                <li class="<?= ($this->params['controller'] == 'members_credits' && $this->params['action'] == "admin_add" ? ' active' : '');?>">
                                <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-angle-double-right"></i>' . __d('member', 'add_members_credit'),
                                    array( 'plugin' => 'member', 'controller' => 'members_credits', 'action' => 'add', 'admin' => true ),
                                    array('escape' => false)
                                );
                                ?>
                            </li>
                            ...
                            <li class="<?= ($this->params['controller'] == 'invite_member_histories' && $this->params['action'] == "admin_add" ? ' active' : '');?>">
                            <?php
                               echo $this->Html->link(
                                   '<i class="fa fa-angle-double-right"></i>' . __d('member', 'invite_member_histories'),
                                   array( 'plugin' => 'member', 'controller' => 'invite_member_histories', 'action' => 'add', 'admin' => true ),
                                   array('escape' => false)
                               );
                            ?>
                           </li>
                         
                            <li class="<?= ($this->params['controller'] == 'members' && $this->params['action'] == "admin_add" ? ' active' : '');?>">
                            <?php
                               echo $this->Html->link(
                                   '<i class="fa fa-angle-double-right"></i>' . __d('member', 'create_member'),
                                   array( 'plugin' => 'member', 'controller' => 'members', 'action' => 'add', 'admin' => true ),
                                   array('escape' => false)
                               );
                           ?>
                           </li>
                ...
                <li class="treeview <?php echo ($this->params['controller'] == 'student_classes'?' active':'');?>">
                    <a href="#">
                        <i class="fa fa-book"></i>
                        <span><?= __d('school', 'student_class'); ?></span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <?php
                            echo $this->Html->link(
                                '<i class="fa fa-angle-double-right"></i>' . __d('school', 'student_class'),
                ...
                <li class="treeview <?php
                    ...
                    <a href="#">
                        <i class="fa fa-book"></i>
                        <span><?= __d('member', 'member_record'); ?></span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li class="<?= ($this->params['controller'] == 'members' && $this->params['action'] == "admin_index" ? ' active' : '');?>">
                            <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-angle-double-right"></i>' . __d('member', 'members'),
                        ...
                        <li class="<?= ($this->params['controller'] == 'invite_member_histories' && $this->params['action'] == "admin_index" ? ' active' : '');?>">
                            ...
                            <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-angle-double-right"></i>' . __d('member', 'invite_member_record'),
                        ...
                        <li class="<?= ($this->params['controller'] == 'import_histories' && $this->params['action'] == "admin_index" ? ' active' : '');?>">
                            ...
                            <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-angle-double-right"></i>' . __d('member', 'import_histories_record'),
