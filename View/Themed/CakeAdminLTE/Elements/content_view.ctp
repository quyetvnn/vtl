				...
				<div class="box-header">
					<h3 class="box-title">
						...
						if (isset($language['alias'])) {
							...
							if ($language['alias'] == 'zho') {
								echo h(__('zho_version'));

							} elseif ($language['alias'] == 'chi') {
								echo h(__('chi_version'));
							
							} elseif ($language['alias'] == 'eng') {
								echo h(__('eng_version'));
							}
...
<?php if (isset($images) && !empty($images)): ?>
	...
	<div class="col-xs-12"  id="<?= $id_cover_images ?>">
