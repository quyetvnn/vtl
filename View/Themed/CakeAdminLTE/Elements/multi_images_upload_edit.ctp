<div class="form-group images-upload">
		...
		<div class="well well-sm">
			<div class="row images-upload-row">
				<div class="col-xs-4 image-type">
					<h4 class="">
						<?php echo $image[$_model]['image_description']; ?>
					</h4>
					<div class="">
					</div>
				</div>
				...
				<div class="col-xs-7">
					<?php 
						echo $this->Html->image('../'.$image[$_model]['path'], array(
	...
	<div class="row images-upload-row">
		<div class="col-xs-12 text-center">
			<?php 
				echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> '.__('Add Image'), '#', array(
